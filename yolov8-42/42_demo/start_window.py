...
@IDE     ：PyCharm 
@Author  ：YJxyz
@Description  ：主要的图形化界面，本次图形化界面实现的主要技术为pyside6，pyside6官方提供支持
'''
import copy                      # 用于图像复制
import os                        # 用于系统路径查找
import shutil                    # 用于复制
...
WELCOME_SENTENCE = "基于yolov8的动物识别系统"          # 欢迎的句子
ICON_IMAGE = "images/UI/yjxyz.png"                 # 系统logo界面
IMAGE_LEFT_INIT = "images/UI/1.png"              # 图片检测界面初始化左侧图像
IMAGE_RIGHT_INIT = "images/UI/up.jpeg"          # 图片检测界面初始化右侧图像
...
class MainWindow(QTabWidget):
    ...
    def initUI(self):
        ...
        about_img = QLabel()
        about_img.setPixmap(QPixmap('images/UI/xyz.jpg'))
        ...
        label_super.setText("<a href='https://blog.csdn.net/ECHOSON'>作者：YJxyz</a>")
